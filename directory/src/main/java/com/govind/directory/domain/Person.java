package com.govind.directory.domain;
...
public class Person {
	...
	public String toString() {
		return "Person [id=" + id + ", email=" + email + ", name=" + name + ", password=" + password + ", role=" + role
				+ ", enabled=" + enabled + ", birthday=" + birthday + ", created=" + created + ", modified=" + modified
				+ "]";
	}
